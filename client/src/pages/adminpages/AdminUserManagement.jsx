    ...
    <td className="text-right pr-6">
      <div className="flex flex-col items-end gap-1">
        ...
        <button 
          ...
          disabled={isUpdating}
          className="btn btn-ghost btn-xs text-error hover:bg-error/10 transition-colors rounded-lg disabled:opacity-20"
        >
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          <div>
            ...
            <div className="flex items-center gap-3 mt-1">
              <span className="text-[10px] font-black opacity-30 uppercase tracking-[0.2em] text-white">{stats.total} Active Nodes</span>
              {(isRefreshing || updatingUserId) && <RefreshCw className="w-3 h-3 animate-spin text-primary" />}
            </div>
          </div>

          <div className="flex gap-4 w-full lg:w-auto">
            <div className="bg-base-200/50 px-6 py-4 rounded-[2rem] border border-white/5 shadow-sm backdrop-blur-md text-center min-w-[120px]">
              <p className="text-[9px] font-black opacity-40 uppercase tracking-widest text-white">Admins</p>
              <p className="text-2xl font-black text-primary">{stats.admins}</p>
            </div>
            <div className="bg-base-200/50 px-6 py-4 rounded-[2rem] border border-white/5 shadow-sm backdrop-blur-md text-center min-w-[120px]">
              <p className="text-[9px] font-black opacity-40 uppercase tracking-widest text-white">Members</p>
